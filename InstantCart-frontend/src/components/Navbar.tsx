  ...
  return (
    <nav className="bg-white sticky top-0 z-50 border-b border-app-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
        ...
        >
          <img src={logo} alt="InstantCartLogo" className="h-10 w-15" />
          <span className="text-green-900 font-bold">InstantCart</span>
        </Link>
        ...
        <div className="w-full flex items-center justify-end gap-4 lg:gap-10">
          ...
          >
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-8 p-2 bg-orange-50 rounded-full ring ring-orange-500/15 focus:ring-orange-500/30"
              />
            </div>
          </form>
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-1 -right-1 size-4 bg-orange-300 text-white text-[10px] rounded-full flex items-center justify-center">
                  {cartCount}
                </span>
              )}
            </button>
            ...
            <div className="relative">
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border py-2 z-50 animate-fade-in">
                    {user && (
                    ...
                    <div onClick={() => setUserMenuOpen(false)}>
                      ...
                      {user?.role === "VENDOR" && (
                        <Link to="/admin/products" className="dropdown-link">
                          <ShieldIcon size={16} className="text-orange-600" />
