...
const NewsLetter = () => {
    return (
        <>
            <section className="flex flex-col items-center justify-center bg-white p-10 rounded-xl">
                ...
                <h1 className="text-4xl md:text-6xl font-semibold text-gray-900 mt-4">Subscribe to our Newsletter</h1>
                <p className="max-w-lg text-center text-slate-500 mt-6">Get weekly updates on fresh produce, seasonal offers, and wxclusive discounts right to your inbox.</p>
                <form onSubmit={(e)=> e.preventDefault()} className="relative flex items-center rounded-md border border-slate-200 mt-6 text-sm max-w-md w-full">
