        ...
        <section className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 my-14 bg-green-950 rounded-2xl'>
            <div className='flex flex-col md:flex-row items-center justify-between gap-8 xl:px-10'>
                ...
                <div className='text-center md:text-left'>
                    <h2 className='font-serif text-3xl sm:text-4xl text-white mb-3 font-extrabold'>{appPromoBannerData.title}</h2>
                ...
                {/* Right Side Image */}
                <img src={delivery_truck} alt="Delivery Truck" className='max-w-60 sm:max-w-120 xl:pr-10' />
            </div>
