...
function Banner() {
    ...
    return (
        <div>
            { bannerVisible && (
                <div className="bg-linear-to-r from-green-500 via-emerald-800 to-green-600 text-white text-xs sm:text-sm relative overflow-hidden">

                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center gap-6 justify-center">
