...
function FlashDeals() {
  ...
  return (
    <div className="min-h-screen bg-app-cream">
      {/* Banner */}
      <div className="bg-linear-to-r from-violet-300 to-blue-300 text-orange-400 py-10">
        <div className="max-w-7xl mx-auto. px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-black/80 max-w-md mx-auto">Limited-time offers on your favourite organic products. Grab them before they're gone!</p>
