...
function ProductPage() {
    ...
    useEffect(() => {
        ...
        api.get(`/products/${id}`)
            ...
            .then((res) => {
                setRelatedProducts(res.data.filter((p: Product) => p.id !== id));
            })
                ...
                <div className="bg-white/50 rounded-2xl overflow-hidden">
                    <div className="grid md:grid-cols-2 gap-0">
                        ...
                        <div className="p-6 md:p-10 flex flex-col justify-center">
                            <span className="text-xs font-bold text-app-text-light tracking-wider mb-2 capitalize">{categoryLabel}</span>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3 font-semibold rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] ${inCart ? "bg-app-cream text-app-green border border-app-green" : "bg-app-orange text-white hover:bg-app-orange-dark"}`}
                                >
